    ...
    return (
        <>
            ...
            <div className="max-w-5xl p-6 mx-auto mt-12">
                <ReturnNavBar />
                <a href="https://financial-tracker-sage.vercel.app/" target='_blank' className="text-olive-400 underline hover:text-olive-500 duration-300 cursor-pointer text-3xl font-semibold mb-2">Financial Tracker - Case Study</a>
