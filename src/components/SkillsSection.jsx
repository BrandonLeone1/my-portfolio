...
export default function SkillsSection () {
    ...
    const infrastructureSkills = ["Docker", "GitHub Actions (CI/CD)", "Git / GitHub", "Linux VPS Hosting"];
    ...
    return (
        ...
        <div className="max-w-6xl mx-auto p-6 mb-24">
            ...
            <p id="skills" className="text-4xl text-neutral-100 font-semibold">Skills</p>
