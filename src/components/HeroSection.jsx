    ...
    return (
        ...
        <div className="flex items-center justify-center h-screen -mt-25" id="hero">
            <div className="flex flex-col gap-6 text-center items-center max-w-5xl p-6 mx-auto">
                ...
                <p className="text-neutral-100 font-medium text-lg">Full-Stack Developer & Data-Focused Problem Solver</p>
                <p className="text-neutral-300/80">Building data-driven applications, analytics dashboards, and scalable user experiences using React, TypeScript, SQL/PostgreSQL, and modern technologies.</p>
