    ...
    return (
        ...
        <div className="flex items-center justify-center h-screen -mt-25" id="hero">
            <div className="flex flex-col gap-6 text-center items-center max-w-5xl p-6 mx-auto">
                ...
                <p className="text-neutral-300/80">I build full-stack web applications with a focus on data integrity, secure backend architecture, and performance optimization. Leveraging a background in marketing analytics, I specialize in engineering clean data pipelines and interactive dashboard infrastructure.</p>
